// RGB565_Convert_to_BMP.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
int Rgb565ConvertBmp(unsigned char* buf, int width, int height, const char* filename)
{
	FILE* fp;
...
int main()
{
	Rgb565ConvertBmp((unsigned char *)imgRGB565, IMG_W, IMG_H, "RGB565.bmp");
